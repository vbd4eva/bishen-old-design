...
},{"process":"../node_modules/process/browser.js"}],"../node_modules/slick-carousel/slick/slick.js":[function(require,module,exports) {
var define;
/*
     _ _      _       _
 ___| (_) ___| | __  (_)___
...
},{"jquery":"../node_modules/jquery/dist/jquery.js"}],"js/buttons/double-arrows.js":[function(require,module,exports) {
...
var singleSlider = _stateSliderClients.default.refs.singleSlider;
var sliderCustomButtons = _stateSliderClients.default.html.sliderCustomButtons; //init slick slider

(0, _jquery.default)(singleSlider).slick(_objectSpread({}, sliderCustomButtons));
},{"jquery":"../node_modules/jquery/dist/jquery.js","slick-carousel":"../node_modules/slick-carousel/slick/slick.js","../buttons/double-arrows":"js/buttons/double-arrows.js","./stateSliderClients":"js/clients-slider/stateSliderClients.js"}],"js/clients-slider/init-IntersectionObserver.js":[function(require,module,exports) {
"use strict";
...
var intersectionObserver = _stateSliderClients.default.intersectionObserver,
    currentSlider = _stateSliderClients.default.currentSlider;
var _stateSliderClients$r = _stateSliderClients.default.refs,
    container = _stateSliderClients$r.container,
    singleSlider = _stateSliderClients$r.singleSlider;
var clientSliders = document.querySelectorAll("".concat(container, " > ").concat(singleSlider)); // const clientSliders = stateSliderClients.getClientsSliders();

var onEntry = function onEntry(entries, observer) {
  entries.forEach(function (entrie) {
    if (entrie.isIntersecting) {
      currentSlider.set(entrie.target);
      console.log("slider " + _stateSliderClients.default.currentSlider.get().id + " is current!");
    }
  });
};

var observer = new IntersectionObserver(onEntry, intersectionObserver.options);
clientSliders.forEach(function (elem) {
  return observer.observe(elem);
});
},{"./stateSliderClients":"js/clients-slider/stateSliderClients.js"}],"../node_modules/debounce/index.js":[function(require,module,exports) {
/**
...
},{}],"js/clients-slider/stop-scroll-listener.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = stopScrollEventListener;

var _debounce = require("debounce");

function stopScrollEventListener() {
  var callback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : function () {
    return console.log('ЗАКОНЧИЛИ ПРОКРУТКУ' + Date.now());
  };
  var delay = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 250;
  console.log('добавляем слушатель на SCROLL');
  window.addEventListener('scroll', (0, _debounce.debounce)(callback, delay));
}

;
},{"debounce":"../node_modules/debounce/index.js"}],"js/clients-slider/finish-scroll-up-slider.js":[function(require,module,exports) {
"use strict";

var _stateSliderClients = _interopRequireDefault(require("./stateSliderClients"));

var _stopScrollListener = _interopRequireDefault(require("./stop-scroll-listener"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var currentSlider = _stateSliderClients.default.currentSlider;
var eventDelay = _stateSliderClients.default.finishScrollUp.eventDelay;

var scrollToTop = function scrollToTop() {
  var _currentSlider$get = currentSlider.get(),
      dataset = _currentSlider$get.dataset,
      offsetHeight = _currentSlider$get.offsetHeight;

  var scrollY = offsetHeight * dataset.id; // console.log(location.hash);
...
(0, _stopScrollListener.default)(scrollToTop, eventDelay);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "5221" + '/');
